...
\begin{figure}[ht]
      ...
      \begin{tikzpicture}[
            ...
            layer/.style={draw,thick,rounded corners,inner sep=6pt, fill opacity=0.08, text opacity=1.0, minimum width=9.2cm},
            ...
            % Fit High-Level Layer Background
            \begin{scope}[on background layer]
                  \node[layer,fill=high,draw=high,fit=(voronoi) (ftcc) (boustro)] (hl) {};
            \end{scope}
            \node[anchor=north west,font=\fontsize{8}{10}\bfseries\color{high},inner sep=3pt]
            ...
            \node[box,draw=mid,below=0.75cm of boustro,xshift=-1.8cm] (fusion)
            ...
            % Fit Mid-Level Layer Background
            \begin{scope}[on background layer]
                  \node[layer,fill=mid,draw=mid,fit=(fusion) (orca)] (ml) {};
            \end{scope}
            \node[anchor=north west,font=\fontsize{8}{10}\bfseries\color{mid},inner sep=3pt]
            ...
            \node[box,draw=low,below=0.65cm of ml] (pidhinf)
            ...
            % Fit Low-Level Layer Background
            \begin{scope}[on background layer]
                  \node[layer,fill=low,draw=low,fit=(pidhinf) (pidlqr)] (ll) {};
            \end{scope}
            \node[anchor=north west,font=\fontsize{8}{10}\bfseries\color{low},inner sep=3pt]
            at (ll.north west) {LOW-LEVEL LAYER --- Attitude \& Position Control};

            % --------  PHYSICAL SIMULATION LAYER  --------
            \node[box,draw=sim,minimum width=4.5cm,below=0.55cm of ll] (plant)
            ...
            \begin{scope}[on background layer]
                  \node[layer,fill=sim,draw=sim,fit=(plant)] (simlayer) {};
            \end{scope}
