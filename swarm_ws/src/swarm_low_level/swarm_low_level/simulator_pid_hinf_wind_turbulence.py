...
def simulate(override_gains=None, return_rmse=False):
    ...
    plt.tight_layout()
    plt.suptitle('Evaluasi Kinerja PID-Hinf Synthesis (Dryden Turbulence Stochastic)', fontsize=16, fontweight='bold')
    plt.tight_layout(rect=[0, 0.03, 1, 0.95])
    plt.savefig('grafik_pid_hinf_wind_turbulence.png', dpi=300)
