...
def simulate():
    ...
    plt.tight_layout()
    plt.suptitle('Evaluasi Kinerja PID-LQR Quadrotor (Wind Step -X, -Y, -Z)', fontsize=16, fontweight='bold')
    plt.tight_layout(rect=[0, 0.03, 1, 0.95])
    plt.savefig('grafik_pid_lqr_wind_step.png', dpi=300)
    print("Sukses! Grafik 4x3 (dengan angin multi-axis) disimpan ke grafik_pid_lqr_wind_step.png")
