...
def simulate():
    ...
    t_end = 10.0 # Simulasi selama 10 detik
    ...
    plt.tight_layout()
    plt.suptitle('Evaluasi Kinerja PID-Hinf Synthesis (Tanpa Angin)', fontsize=16, fontweight='bold')
    plt.tight_layout(rect=[0, 0.03, 1, 0.95])
    plt.savefig('grafik_pid_hinf.png', dpi=300)
    print("Sukses! Grafik 4x3 disimpan ke grafik_pid_hinf.png")
