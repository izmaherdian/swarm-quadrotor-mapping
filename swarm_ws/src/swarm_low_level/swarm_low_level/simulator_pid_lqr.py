...
def simulate():
    ...
    plt.tight_layout()
    plt.suptitle('Evaluasi Kinerja PID-LQR Quadrotor (Tanpa Angin)', fontsize=16, fontweight='bold')
    plt.tight_layout(rect=[0, 0.03, 1, 0.95])
    plt.savefig('grafik_pid_lqr.png', dpi=300)
    print("Sukses! Grafik 4x3 disimpan ke grafik_pid_lqr.png")
